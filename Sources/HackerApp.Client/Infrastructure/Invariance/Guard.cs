...
using HackerApp.Client.Infrastructure.Invariance.Servants;
using JetBrains.Annotations;

namespace HackerApp.Client.Infrastructure.Invariance
{
    [PublicAPI]
    public static class Guard
    {
            ...
            where T : struct, IComparable
        {
            ...
            if (!funcValue.HasValue || funcValue.Value.CompareTo(default(T)) <= 0)
            {
